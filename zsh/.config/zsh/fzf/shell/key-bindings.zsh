...
fzf-bookmarks() {
    ...
    # Reads booksmarkrc and moves you to that directory

    local sel_file="$(cat "$HOME/.config/bookmarkrc" | grep -v "#" | fzf)"
...
fzf-edit() {
    ...
    local sel_file="$(find * -type f | fzf)"

    [ "$sel_file" != "" ] && $EDITOR "$sel_file"
...
zle     -N            fzf-edit
bindkey -M emacs '^P' fzf-edit
bindkey -M vicmd '^P' fzf-edit
bindkey -M viins '^P' fzf-edit
