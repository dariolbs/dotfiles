...
static int soloborders        = 1;        /* 1 means no solo borders */
...
/* Define prefered attachment method */
/* Existing methods: attach (default), attachbottom */
static void
attachpref(Client *c)
{
    attachbottom(c);
...
static const char *dmenucmd[] = { "dmenu_bin", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
...
static const Key keys[] = {
	...
	{ MODKEY, 	                    XK_Tab,    setlayout,      {.v = &layouts[9]} },
	{ MODKEY|ShiftMask,             XK_Tab,    setlayout,      {.v = &layouts[10]} },
    // Monitors
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        sigdwmblocks,   {.i = 3} },
	{ ClkStatusText,        0,              Button3,        sigdwmblocks,   {.i = 2} },
